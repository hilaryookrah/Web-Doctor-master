...
<body>
  ...
  <div class="site-wrap">
          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                <li class="active"><a href="pharmcy.html">Home</a></li>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="pharmacy.html">Home</a> <span class="mx-2 mb-0">/</span> <a
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p>Ibuprofen 200mg tablets provide fast relief from pain, inflammation, and fever. 
              They work by reducing prostaglandin levels in the body. Take with food to minimize stomach upset. 
              Follow dosage instructions carefully. 
              Avoid if you have certain medical conditions or are taking other NSAIDs.</p>
            

            <p><del>200.00 cedis</del>  <strong class="text-primary h4">150.00 cedis</strong></p>
