...
<input type='text' name='med_id' value='" . $mid . "' hidden/> 
                    ...
                    <td>
                      <div class='input-group mb-3' style='max-width: 120px;'>
                        ...
                        <a href='../actions/update_qty.php?action=0&m_id=1".$mid."'><button class='btn btn-outline-primary js-btn-minus' type='button'>&minus;</button></a>
                        </div>
                        <input type='text' class='form-control text-center' value='" . $medicine_qty . "' placeholder=''
                          aria-label='Example text with button addon' aria-describedby='button-addon1'>
                        <div class='input-group-append'>
                        <a href='../actions/update_qty.php?action=0&m_id=1".$mid."'><button class='btn btn-outline-primary js-btn-plus' type='button'>&plus;</button></a>
                        </div>
                      </div>
