...
function displayChores($cid,$url,$med_name,$medicine_qty,$medicine_price){
    $medicine="  <div class='col-sm-6 col-lg-4 text-center item mb-4'>
    <a href='shop-single.html'> <img src='".$url."' alt='Image'></a>
...
foreach($meds as $med){
    ...
    $count+=1;
    echo displayChores($med['medicine_id'],$med['img_url'],$med['medicine_name'],$med['medicine_qty'],$med['medicine_price']);
    if($count==3){
        $item=0;
        echo "</div>";
        $count=0;
