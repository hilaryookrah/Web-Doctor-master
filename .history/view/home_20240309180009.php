      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="profile">
            ...
            <?php
              if (isset($_SESSION['id'])) {
                echo "<a href='cart.php'><img src='https://img.icons8.com/ios/50/000000/shopping-cart.png' alt='Image' class='rounded-circle' style='width:50px; border-radius:50px;'></a>;
              } else {
                echo "<a href='../login/login.php'><img src='../img/cart.png' alt='Image' class='rounded-circle' style='width:50px; border-radius:50px;'></a>";
              }
            ?>
            <!-- profile -->
            <a href="
