                            ...
                            <div class="row justify-content-center">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" id="uname" name="uname" class="form-control" value="<?php echo $_SESSION['username']; ?>" disabled>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" id="email" name="email" class="form-control" value="<?php echo $_SESSION['email']; ?>" disabled>

                                    </div>
                                    <div class="col">
                                        <label for="phone">Phone</label>
                                        <input type="text" id="phone" name="phone" class="form-control" value="<?php echo $_SESSION['phone']; ?>" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <label for="address">Address</label>
                                        <input type="text" id="address" name="address" class="form-control" value="<?php echo $_SESSION['address']; ?>" disabled>
                                    </div>
