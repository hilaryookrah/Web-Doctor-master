            ...
            <div class="site-block-cover-content text-center">
             <!--Profile page-->
                ...
                <div class="row justify-content-center">
                    <div class="row">
                        <div class="col"><p>USername</p><?php     
                               echo $_SESSION['username'];
            ?></div>
                        <div class="col"><p>First Name</p><?php     
                               echo $_SESSION['fname'];
            ?></div>
                        <div class="col"><p>Last Name</p><?php     
                               echo $_SESSION['lname'];
            ?></div>
                    </div>
                    <div class="row">
                        <div class="col"><p>Email</p><?php     
                               echo $_SESSION['email'];
            ?></div>
                        <div class="col"><p>Phone</p><?php     
                               echo $_SESSION['phone'];
            ?></div>
                    </div>
                    <div class="row">
                        <div class="col"><p>Address</p><?php     
