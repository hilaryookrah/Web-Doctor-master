...
(2, 'Ava','lynn','a.l@a.c',0921093102,'asd','$2y$10$ECHIPPZkVnVonsM53RiHIuGxTZn79WKjk5YpOaQxXRRHlZGoWH/fW');

INSERT INTO `cart` (`cart_id`, `p_id`, `med_id`, `qty`, `total_cost`) VALUES
(1, 1, 1, 2, 20),
(2, 1, 2, 2, 20),
(3, 1, 3, 2, 20),
(4, 1, 4, 2, 20),
